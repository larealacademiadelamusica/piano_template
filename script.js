...
/* Choose chords with select */

$('.chords select').change(function(){
  var note = $('.chords #noteSelector').val();
  var chord = $('.chords #typeSelector').val();
  ...
  if( (note != "") && (note2 != 0) && (note3 != 0) && (note4 != 0) ) {
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(t) {
  ...
  var notes = {
      "1C": new Howl({
          urls: [ "https://assets.codepen.io/4474141/261-C.mp3" ]
      }),
      "1Cs": new Howl({
          urls: [ "https://assets.codepen.io/4474141/277-C-sharp.mp3" ]
      }),
      "1D": new Howl({
          urls: [ "https://assets.codepen.io/4474141/293-D.mp3" ]
      }),
      "1Ds": new Howl({
          urls: [ "https://assets.codepen.io/4474141/311-D-sharp.mp3" ]
      }),
      "1E": new Howl({
          urls: [ "https://assets.codepen.io/4474141/329-E.mp3" ]
      }),
      "1F": new Howl({
          urls: [ "https://assets.codepen.io/4474141/349-F.mp3" ]
      }),
      "1Fs": new Howl({
          urls: [ "https://assets.codepen.io/4474141/369F-sharp.mp3" ]
      }),
      "1G": new Howl({
          urls: [ "https://assets.codepen.io/4474141/391-G.mp3" ]
      }),
      "1Gs": new Howl({
          urls: [ "https://assets.codepen.io/4474141/415-G-sharp.mp3" ]
      }),
      "2A": new Howl({
          urls: [ "https://assets.codepen.io/4474141/440-A.mp3" ]
      }),
      "2As": new Howl({
          urls: [ "https://assets.codepen.io/4474141/466-A-sharp.mp3" ]
      }),
      "2B": new Howl({
          urls: [ "https://assets.codepen.io/4474141/495-B.mp3" ]
      }),
      "2C": new Howl({
          urls: [ "https://assets.codepen.io/4474141/523-C.mp3" ]
      }),
      "2Cs": new Howl({
          urls: [ "https://assets.codepen.io/4474141/545-C-sharp.mp3" ]
      }),
      "2D": new Howl({
          urls: [ "https://assets.codepen.io/4474141/587-D.mp3" ]
      }),
      "2Ds": new Howl({
          urls: [ "https://assets.codepen.io/4474141/622-D-sharp.mp3" ]
      }),
      "2E": new Howl({
          urls: [ "https://assets.codepen.io/4474141/659-E.mp3" ]
      }),
      "2F": new Howl({
          urls: [ "https://assets.codepen.io/4474141/698-F.mp3" ]
      }),
      "2Fs": new Howl({
          urls: [ "https://assets.codepen.io/4474141/698-F-sharp.mp3" ]
      }),
      "2G": new Howl({
          urls: [ "https://assets.codepen.io/4474141/783-G.mp3" ]
      }),
      "2Gs": new Howl({
          urls: [ "https://assets.codepen.io/4474141/830-G-sharp.mp3" ]
      }),
      "3A": new Howl({
          urls: [ "https://assets.codepen.io/4474141/880-A.mp3" ]
      }),
      "3As": new Howl({
          urls: [ "https://assets.codepen.io/4474141/932-A-sharp.mp3" ]
      }),
      "3B": new Howl({
          urls: [ "https://assets.codepen.io/4474141/987-B.mp3" ]
      })
  }, lockEvent = {};
  $(".piano").bind("selectstart dragstart", function(ev) {
      ...
      var note = $(".chords #noteSelector").val(), chord = $(".chords #typeSelector").val(), note1 = parseInt(note), note2 = 0, note3 = 0, note4 = 0;
      switch (chord) {
        case "Maj":
          note2 = note1 + 4, note3 = note1 + 7, note4 = note1 + 12;
          break;

        case "Min":
          note2 = note1 + 3, note3 = note1 + 7, note4 = note1 + 12;
          break;

        case "Maj7":
          note2 = note1 + 4, note3 = note1 + 7, note4 = note1 + 10;
          break;

        case "Min7":
          note2 = note1 + 3, note3 = note1 + 7, note4 = note1 + 10;
          break;

        case "Sus2":
          note2 = note1 + 2, note3 = note1 + 7, note4 = note1 + 12;
          break;

        case "Sus4":
          note2 = note1 + 5, note3 = note1 + 7, note4 = note1 + 12;
          break;

        case "11Sus4":
          note2 = note1 + 5, note3 = note1 + 7, note4 = note1 + 10;
          break;

        case "Add2":
          note2 = note1 + 4, note3 = note1 + 7, note4 = note1 + 14;
          break;

        case "Addm2":
          note2 = note1 + 4, note3 = note1 + 7, note4 = note1 + 13;
          break;

        case "Addm3":
          note2 = note1 + 4, note3 = note1 + 7, note4 = note1 + 15;
          break;

        case "Aug":
          note2 = note1 + 4, note3 = note1 + 8, note4 = note1 + 12;
          break;

        case "Dim":
          note2 = note1 + 3, note3 = note1 + 6, note4 = note1 + 12;
          break;

        case "7Dim":
          note2 = note1 + 3, note3 = note1 + 6, note4 = note1 + 10;
          break;

        case "Sixt":
          note2 = note1 + 4, note3 = note1 + 7, note4 = note1 + 9;
          break;

        case "m6":
          note2 = note1 + 3, note3 = note1 + 7, note4 = note1 + 9;
          break;

        default:
          console.log("No chord selected");
      }
      $("[data-number='" + note1 + "']").addClass("active"), $("[data-number='" + note1 + "']").parent("li").addClass("active"), 
      $("[data-number='" + note2 + "']").addClass("active"), $("[data-number='" + note2 + "']").parent("li").addClass("active"), 
      $("[data-number='" + note3 + "']").addClass("active"), $("[data-number='" + note3 + "']").parent("li").addClass("active"), 
      $("[data-number='" + note4 + "']").addClass("active"), $("[data-number='" + note4 + "']").parent("li").addClass("active");
      var dataNote1 = "", dataNote2 = "", dataNote3 = "", dataNote4 = "";
      "" != note && (dataNote1 = $("[data-number='" + note1 + "']").data("note"), notes[dataNote1].play()), 
      "" != note && 0 != note2 && 0 != note3 && 0 != note4 && (dataNote2 = $("[data-number='" + note2 + "']").data("note"), 
      dataNote3 = $("[data-number='" + note3 + "']").data("note"), dataNote4 = $("[data-number='" + note4 + "']").data("note"), 
      notes[dataNote2].play(), notes[dataNote3].play(), notes[dataNote4].play()), setTimeout(function() {
          $("[data-note]").removeClass("active"), $("[data-note]").parent("li").removeClass("active");
      }, 1500);
  });
}();